...
The primary goal is to refactor the code in Algorithm\Finder.cs as it stands
...
You can stop when you feel the code is good enough, something you can 
come back to in 6 months and understand. 